...
class easy:
    ...
    def RUN(self):
        while self.run:
            ...
            word.word(self, 1, self.hit_count)
            self.block.draw()
            ...
            if self.illu1_move_up:
                self.illu_ball1.illu_ball_y += self.ball_speed - 0.005
                self.illu1_move_down = False
            ...
            if self.illu2_move_up:
                self.illu_ball2.illu_ball_y += self.ball_speed - 0.005
                self.illu2_move_down = False
            ...
            if self.illu3_move_up:
                self.illu_ball3.illu_ball_y += self.ball_speed - 0.005
                self.illu3_move_down = False
            ...
            if self.power_move_down:
                self.power_ball.power_ball_y -= self.ball_speed - 0.005
